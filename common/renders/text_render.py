...
class TextRender():
    ...
    def f_percent(cls, value):
        return format_decimal(abs(value) * 100, format='#,##0.##;-#', locale='vi_VN') + "%"
    ...
    @classmethod
    def f_times(cls, value):
        return format_decimal(value, format='#,##0.#;-#', locale='vi_VN')
    ...
    def __init__(self, input_data) -> None:
        ...
        self.env.filters['f_times'] = self.f_times
